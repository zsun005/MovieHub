package edu.uci.ics.zexis1.service.idm.security;
...
public class Session {
    public static final long SESSION_TIMEOUT = IDMService.getConfigs().getTimeout(); // 10-minute timeout
    public static final long TOKEN_EXPR = IDMService.getConfigs().getExpiration(); // 30-minute expiration

package edu.uci.ics.zexis1.service.billing;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.zexis1.service.billing.configs.Configs;
import edu.uci.ics.zexis1.service.billing.logger.ServiceLogger;
import edu.uci.ics.zexis1.service.billing.models.ConfigsModel;
...
public class BillingService {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.zexis1.service.billing.resources");
...
//            server.getServerConfiguration().addHttpHandler(new CLStaticHttpHandler(BillingService.class.getClassLoader()),
//                    "www");
            server.start();
